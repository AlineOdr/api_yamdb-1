    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code=400, message='allows 150 characters or fewer @/./+/-/_ and digits', regex='^[\\w.@+-]+\\Z'), reviews.validators.validate_bad_value_in_username])),
